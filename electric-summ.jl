...
# ╔═╡ 04f2e158-6cf0-11ed-26e7-c9afd249a278
using CSV, CairoMakie, DataFrames, Dates

# ╔═╡ 77cdd298-6519-4c69-80eb-9277b90393d3
### Imports ###

# ╔═╡ 750d85d0-533f-4b10-9e16-fe1fe178d9ff


# ╔═╡ fc8deacb-34c9-4dd5-8857-575acec590da
### Inputs ###

# ╔═╡ 31e7ac10-0dc9-4b0c-b364-3e128dd9b2b4
wind = CSV.read("wind-gen.csv", DataFrame)[!, 1:end-1]

# ╔═╡ b0b83697-e030-4977-bc4c-b464114fd3b2
sysdem = CSV.read("system-demand.csv", DataFrame)[!, 1:end-2]

# ╔═╡ 7b167d99-abee-4e25-a2c2-4df5d78e5ba6


# ╔═╡ 355be498-10ac-4bf7-891c-737dc5c8a7d5
### Processes ###

# ╔═╡ c86693a5-5c8a-4acd-b14a-2fe780e0fbdb
days1 = length(wind.forecast)

# ╔═╡ 15c84279-ff63-4330-9114-a2d10d850cd4
date1 = Date(wind.period[1], "d U y H:M")

# ╔═╡ 0c386f8e-31e4-4e4f-81a2-6156f3c2cb00
dayname(date1)

# ╔═╡ 66cb7627-e43a-4ca5-9d6c-a4f392879285
mondays = unique(
...
# ╔═╡ 8903dd89-5a53-4f7e-b2b8-928efaf30f68
mondayticks = ((96*3):(96*7):days1, string.(mondays))

# ╔═╡ d6e48b5e-ca3c-4c84-94ee-a35de8bf7165


# ╔═╡ 18e6d4e5-d948-4d69-b0ee-7abb96bd161b
fig1 = Figure()

# ╔═╡ a4f7c39a-f719-4b83-8daa-560528bebca0
ax1 = Axis(
	fig1[1,1], 
	xlabel="Day", 
	xticks=mondayticks,
...
# ╔═╡ 2d77c580-95cb-4ac4-acfd-576cee86dc2b
...
# ╔═╡ 41708bae-34e0-4e14-9187-a7d2f7dd8e97
...
# ╔═╡ 170e5ff5-d8bc-4fba-832e-535e7b8a2a82
axislegend(ax1)

# ╔═╡ 65412350-7ef1-407d-9b1e-6cc4358f133e
fig1

# ╔═╡ 5e873201-29b4-427b-8e8d-651ff69151b2


# ╔═╡ 1952e464-9662-48a7-b3a4-af5c96c90748
days2 = length(sysdem.actual)

# ╔═╡ 5933ed9f-1489-4ca6-9da4-134c4681a3ad
date2 = Date(sysdem.period[1], "d U y H:M")

# ╔═╡ 46d3f77d-c1d6-46e0-8c57-0a49a445573e
dayname(date2)

# ╔═╡ 736ea726-aa11-4fe3-8e7f-983a1abc1c95
mondays2 = unique(
...
# ╔═╡ 004c05c6-dd3a-457f-ba98-f5d53bad419e
yticks = (3:4:24, string.(["2:00", "6:00", "10:00", "14:00", "18:00", "22:00"]))

# ╔═╡ 5a1fd341-03ba-4d4b-9540-28eb2d0678d2
fig2 = Figure()

# ╔═╡ 4a27d93c-5102-4f34-b3c4-9f349562425a
ax2 = Axis(
	fig2[1,1],
	xlabel="Day", 
...
# ╔═╡ 5242e0b3-0b52-410b-a98e-abec081e02bd
sysdemParsed = map(sysdem.actual) do elem
		elem == "-" ? missing : parse(Int, elem)
end

# ╔═╡ d1358920-9e9b-4efb-aff1-cae0d492b190
sysdemHourly = []

# ╔═╡ 7f60f045-ab4e-4a53-87cd-d86447f8e512
for i in 1:4:days2
...
# ╔═╡ 130f4f9b-e897-4703-95db-9fcc2157cfbb
...
# ╔═╡ e1582fc7-1199-47a8-816b-95e03da8d37f
sysdemHM = heatmap!(ax2, sysdemMatrix')

# ╔═╡ 5a46355d-ccef-4832-89c1-cfb8486b894c
cb2 = Colorbar(fig2[1,2], sysdemHM)

# ╔═╡ ef7403e1-de01-4de7-bd9d-fc621d2774ad
...
# ╔═╡ b706bdb0-38e6-4f29-9dfc-9f11409ef994
fig2

# ╔═╡ 6d4c2da5-0f35-4c4f-a6f8-6ef6bf5f7644


# ╔═╡ d2425bc7-4656-4e8f-a547-930b45517b1a
### Outputs ###

# ╔═╡ 9dedcd3e-5cae-4517-807f-ae5b7ff25b11
save("wind-gen.png", fig1)

# ╔═╡ 5d09c8b8-b40d-4582-a3ba-d8000b412b27
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "fbfa1f6308d35029caa775633fb26c7d9759faf2"
